...
import org.sitebay.android.fluxc.action.WCProductAction
import org.sitebay.android.fluxc.generated.WCProductActionBuilder
...
import org.sitebay.android.fluxc.model.WCProductCategoryModel
import org.sitebay.android.fluxc.model.WCProductImageModel
import org.sitebay.android.fluxc.model.WCProductModel
import org.sitebay.android.fluxc.model.WCProductReviewModel
import org.sitebay.android.fluxc.model.WCProductShippingClassModel
import org.sitebay.android.fluxc.model.WCProductTagModel
import org.sitebay.android.fluxc.model.WCProductVariationModel
...
import org.sitebay.android.fluxc.network.rest.wpcom.WPComGsonRequest.WPComErrorListener
...
import org.sitebay.android.fluxc.network.rest.wpcom.jetpacktunnel.JetpackTunnelGsonRequest
...
import org.sitebay.android.fluxc.network.rest.wpcom.post.PostWPComRestResponse
...
import org.sitebay.android.fluxc.store.WCProductStore
import org.sitebay.android.fluxc.store.WCProductStore.Companion.DEFAULT_CATEGORY_SORTING
import org.sitebay.android.fluxc.store.WCProductStore.Companion.DEFAULT_PRODUCT_CATEGORY_PAGE_SIZE
import org.sitebay.android.fluxc.store.WCProductStore.Companion.DEFAULT_PRODUCT_PAGE_SIZE
import org.sitebay.android.fluxc.store.WCProductStore.Companion.DEFAULT_PRODUCT_SHIPPING_CLASS_PAGE_SIZE
import org.sitebay.android.fluxc.store.WCProductStore.Companion.DEFAULT_PRODUCT_SORTING
import org.sitebay.android.fluxc.store.WCProductStore.Companion.DEFAULT_PRODUCT_TAGS_PAGE_SIZE
import org.sitebay.android.fluxc.store.WCProductStore.Companion.DEFAULT_PRODUCT_VARIATIONS_PAGE_SIZE
import org.sitebay.android.fluxc.store.WCProductStore.FetchProductReviewsResponsePayload
import org.sitebay.android.fluxc.store.WCProductStore.ProductCategorySorting
import org.sitebay.android.fluxc.store.WCProductStore.ProductCategorySorting.NAME_DESC
import org.sitebay.android.fluxc.store.WCProductStore.ProductError
import org.sitebay.android.fluxc.store.WCProductStore.ProductErrorType
import org.sitebay.android.fluxc.store.WCProductStore.ProductFilterOption
import org.sitebay.android.fluxc.store.WCProductStore.ProductSorting
import org.sitebay.android.fluxc.store.WCProductStore.ProductSorting.DATE_ASC
import org.sitebay.android.fluxc.store.WCProductStore.ProductSorting.DATE_DESC
import org.sitebay.android.fluxc.store.WCProductStore.ProductSorting.TITLE_ASC
import org.sitebay.android.fluxc.store.WCProductStore.ProductSorting.TITLE_DESC
import org.sitebay.android.fluxc.store.WCProductStore.RemoteAddProductCategoryResponsePayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteAddProductPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteAddProductTagsResponsePayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteDeleteProductPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductCategoriesPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductListPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductPasswordPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductReviewPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductShippingClassListPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductShippingClassPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductSkuAvailabilityPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductTagsPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteProductVariationsPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteSearchProductsPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteUpdateProductImagesPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteUpdateProductPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteUpdateVariationPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteUpdatedProductPasswordPayload
import org.sitebay.android.fluxc.store.WCProductStore.RemoteVariationPayload
import org.sitebay.android.fluxc.utils.handleResult
import org.sitebay.android.fluxc.utils.putIfNotEmpty

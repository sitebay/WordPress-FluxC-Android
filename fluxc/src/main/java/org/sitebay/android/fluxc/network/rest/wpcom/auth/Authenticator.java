package org.sitebay.android.fluxc.network.rest.wpcom.auth;
...
import org.sitebay.android.fluxc.store.AccountStore.AuthEmailError;
...
public class Authenticator {
    private static final String WPCOM_OAUTH_PREFIX = "https://mytest.sitebay.org/api/tokens";
    private static final String AUTHORIZE_ENDPOINT = WPCOM_OAUTH_PREFIX + "/";

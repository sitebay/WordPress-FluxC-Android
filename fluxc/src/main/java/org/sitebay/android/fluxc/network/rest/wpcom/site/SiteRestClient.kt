...
import org.sitebay.android.fluxc.network.rest.wpcom.site.SiteWPComRestResponse.SitesResponse
import org.sitebay.android.fluxc.network.rest.wpcom.site.UserRoleWPComRestResponse.UserRolesResponse
import org.sitebay.android.fluxc.store.SiteStore.AccessCookieErrorType
import org.sitebay.android.fluxc.store.SiteStore.AutomatedTransferEligibilityResponsePayload
import org.sitebay.android.fluxc.store.SiteStore.AutomatedTransferError
...
import org.sitebay.android.fluxc.store.SiteStore.DomainAvailabilityError
import org.sitebay.android.fluxc.store.SiteStore.DomainAvailabilityErrorType
import org.sitebay.android.fluxc.store.SiteStore.DomainAvailabilityResponsePayload
import org.sitebay.android.fluxc.store.SiteStore.DomainAvailabilityStatus
import org.sitebay.android.fluxc.store.SiteStore.DomainMappabilityStatus
import org.sitebay.android.fluxc.store.SiteStore.DomainSupportedCountriesError
import org.sitebay.android.fluxc.store.SiteStore.DomainSupportedCountriesErrorType
...
import org.sitebay.android.fluxc.store.SiteStore.FetchedPostFormatsPayload
...
import org.sitebay.android.fluxc.store.SiteStore.JetpackCapabilitiesErrorType
import org.sitebay.android.fluxc.store.SiteStore.NewSiteError
import org.sitebay.android.fluxc.store.SiteStore.NewSiteErrorType
import org.sitebay.android.fluxc.store.SiteStore.PlansError
import org.sitebay.android.fluxc.store.SiteStore.PostFormatsError
import org.sitebay.android.fluxc.store.SiteStore.PostFormatsErrorType
import org.sitebay.android.fluxc.store.SiteStore.PrivateAtomicCookieError
import org.sitebay.android.fluxc.store.SiteStore.QuickStartCompletedResponsePayload
import org.sitebay.android.fluxc.store.SiteStore.QuickStartError
import org.sitebay.android.fluxc.store.SiteStore.QuickStartErrorType
import org.sitebay.android.fluxc.store.SiteStore.SiteEditorsError
import org.sitebay.android.fluxc.store.SiteStore.SiteEditorsErrorType.GENERIC_ERROR
import org.sitebay.android.fluxc.store.SiteStore.SiteError
import org.sitebay.android.fluxc.store.SiteStore.SiteErrorType
import org.sitebay.android.fluxc.store.SiteStore.SiteErrorType.INVALID_SITE
import org.sitebay.android.fluxc.store.SiteStore.SiteErrorType.UNAUTHORIZED
import org.sitebay.android.fluxc.store.SiteStore.SiteErrorType.UNKNOWN_SITE
...
import org.sitebay.android.fluxc.store.SiteStore.SuggestDomainErrorType.EMPTY_RESULTS
import org.sitebay.android.fluxc.store.SiteStore.SuggestDomainsResponsePayload
import org.sitebay.android.fluxc.store.SiteStore.UserRolesError
import org.sitebay.android.fluxc.store.SiteStore.UserRolesErrorType
...
class SiteRestClient @Inject constructor(
    ...
    fun suggestDomains(
        ...
        if (onlyWordpressCom != null) {
            params["only_sitebaydotcom"] = onlyWordpressCom.toString() // CHECKSTYLE IGNORE
        }
        if (includeWordpressCom != null) {
            params["include_sitebaydotcom"] = includeWordpressCom.toString() // CHECKSTYLE IGNORE
        }
    ...
    private fun siteResponseToSiteModel(from: SiteWPComRestResponse): SiteModel {
        ...
        if (from.quota != null) {
            ...
            Log.i("MYLOG", "SET QUOTA")
        }
        if (from.icon != null) {
            Log.i("MYLOG", "SET ICON" + from.icon.img)

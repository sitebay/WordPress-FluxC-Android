...
import org.sitebay.android.fluxc.network.discovery.DiscoveryWPAPIRestClient
import org.sitebay.android.fluxc.network.rest.wpapi.reactnative.Nonce
...
import org.sitebay.android.fluxc.network.rest.wpapi.reactnative.ReactNativeWPAPIRestClient
import org.sitebay.android.fluxc.network.rest.wpcom.reactnative.ReactNativeWPComRestClient
...
@VisibleForTesting constructor(
    ...
    private val WPCOM_ENDPOINT = "https://mytest.sitebay.org/api"

...
import org.sitebay.android.fluxc.action.SiteAction.CHECKED_AUTOMATED_TRANSFER_ELIGIBILITY
import org.sitebay.android.fluxc.action.SiteAction.CHECKED_AUTOMATED_TRANSFER_STATUS
import org.sitebay.android.fluxc.action.SiteAction.CHECKED_DOMAIN_AVAILABILITY
import org.sitebay.android.fluxc.action.SiteAction.CHECKED_IS_WPCOM_URL
import org.sitebay.android.fluxc.action.SiteAction.CHECK_AUTOMATED_TRANSFER_ELIGIBILITY
import org.sitebay.android.fluxc.action.SiteAction.CHECK_AUTOMATED_TRANSFER_STATUS
import org.sitebay.android.fluxc.action.SiteAction.CHECK_DOMAIN_AVAILABILITY
import org.sitebay.android.fluxc.action.SiteAction.COMPLETED_QUICK_START
import org.sitebay.android.fluxc.action.SiteAction.COMPLETE_QUICK_START
import org.sitebay.android.fluxc.action.SiteAction.CREATE_NEW_SITE
import org.sitebay.android.fluxc.action.SiteAction.DELETED_SITE
import org.sitebay.android.fluxc.action.SiteAction.DELETE_SITE
import org.sitebay.android.fluxc.action.SiteAction.DESIGNATED_MOBILE_EDITOR_FOR_ALL_SITES
import org.sitebay.android.fluxc.action.SiteAction.DESIGNATED_PRIMARY_DOMAIN
import org.sitebay.android.fluxc.action.SiteAction.DESIGNATE_MOBILE_EDITOR
import org.sitebay.android.fluxc.action.SiteAction.DESIGNATE_MOBILE_EDITOR_FOR_ALL_SITES
import org.sitebay.android.fluxc.action.SiteAction.DESIGNATE_PRIMARY_DOMAIN
import org.sitebay.android.fluxc.action.SiteAction.EXPORTED_SITE
import org.sitebay.android.fluxc.action.SiteAction.EXPORT_SITE
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_BLOCK_LAYOUTS
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_CONNECT_SITE_INFO
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_DOMAIN_SUPPORTED_COUNTRIES
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_DOMAIN_SUPPORTED_STATES
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_JETPACK_CAPABILITIES
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_PLANS
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_PRIVATE_ATOMIC_COOKIE
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_PROFILE_XML_RPC
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_SITE_EDITORS
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_USER_ROLES
import org.sitebay.android.fluxc.action.SiteAction.FETCHED_WPCOM_SITE_BY_URL
import org.sitebay.android.fluxc.action.SiteAction.FETCH_BLOCK_LAYOUTS
import org.sitebay.android.fluxc.action.SiteAction.FETCH_CONNECT_SITE_INFO
import org.sitebay.android.fluxc.action.SiteAction.FETCH_DOMAIN_SUPPORTED_COUNTRIES
import org.sitebay.android.fluxc.action.SiteAction.FETCH_DOMAIN_SUPPORTED_STATES
import org.sitebay.android.fluxc.action.SiteAction.FETCH_JETPACK_CAPABILITIES
import org.sitebay.android.fluxc.action.SiteAction.FETCH_PLANS
import org.sitebay.android.fluxc.action.SiteAction.FETCH_POST_FORMATS
import org.sitebay.android.fluxc.action.SiteAction.FETCH_PRIVATE_ATOMIC_COOKIE
import org.sitebay.android.fluxc.action.SiteAction.FETCH_PROFILE_XML_RPC
import org.sitebay.android.fluxc.action.SiteAction.FETCH_SITE
import org.sitebay.android.fluxc.action.SiteAction.FETCH_SITES
import org.sitebay.android.fluxc.action.SiteAction.FETCH_SITES_XML_RPC
import org.sitebay.android.fluxc.action.SiteAction.FETCH_SITE_EDITORS
import org.sitebay.android.fluxc.action.SiteAction.FETCH_USER_ROLES
import org.sitebay.android.fluxc.action.SiteAction.FETCH_WPCOM_SITE_BY_URL
import org.sitebay.android.fluxc.action.SiteAction.HIDE_SITES
import org.sitebay.android.fluxc.action.SiteAction.INITIATED_AUTOMATED_TRANSFER
import org.sitebay.android.fluxc.action.SiteAction.INITIATE_AUTOMATED_TRANSFER
import org.sitebay.android.fluxc.action.SiteAction.IS_WPCOM_URL
import org.sitebay.android.fluxc.action.SiteAction.REMOVE_ALL_SITES
import org.sitebay.android.fluxc.action.SiteAction.REMOVE_SITE
import org.sitebay.android.fluxc.action.SiteAction.REMOVE_WPCOM_AND_JETPACK_SITES
import org.sitebay.android.fluxc.action.SiteAction.SHOW_SITES
import org.sitebay.android.fluxc.action.SiteAction.SUGGESTED_DOMAINS
import org.sitebay.android.fluxc.action.SiteAction.SUGGEST_DOMAINS
import org.sitebay.android.fluxc.action.SiteAction.UPDATE_SITE
import org.sitebay.android.fluxc.action.SiteAction.UPDATE_SITES
...
import org.sitebay.android.fluxc.network.rest.wpcom.site.PrivateAtomicCookieResponse
import org.sitebay.android.fluxc.network.rest.wpcom.site.SiteRestClient
...
import org.sitebay.android.fluxc.network.rest.wpcom.site.SiteRestClient.NewSiteResponsePayload
import org.sitebay.android.fluxc.network.rest.wpcom.site.SupportedCountryResponse
import org.sitebay.android.fluxc.network.rest.wpcom.site.SupportedStateResponse
import org.sitebay.android.fluxc.network.xmlrpc.site.SiteXMLRPCClient
import org.sitebay.android.fluxc.persistence.PostSqlUtils
import org.sitebay.android.fluxc.persistence.SiteSqlUtils
import org.sitebay.android.fluxc.persistence.SiteSqlUtils.DuplicateSiteException
import org.sitebay.android.fluxc.store.SiteStore.AccessCookieErrorType.INVALID_RESPONSE
import org.sitebay.android.fluxc.store.SiteStore.AccessCookieErrorType.NON_PRIVATE_AT_SITE
import org.sitebay.android.fluxc.store.SiteStore.AccessCookieErrorType.SITE_MISSING_FROM_STORE
import org.sitebay.android.fluxc.store.SiteStore.DeleteSiteErrorType.INVALID_SITE
import org.sitebay.android.fluxc.store.SiteStore.DomainAvailabilityErrorType.INVALID_DOMAIN_NAME
import org.sitebay.android.fluxc.store.SiteStore.DomainSupportedStatesErrorType.INVALID_COUNTRY_CODE
import org.sitebay.android.fluxc.store.SiteStore.ExportSiteErrorType.GENERIC_ERROR
import org.sitebay.android.fluxc.store.SiteStore.PlansErrorType.NOT_AVAILABLE
import org.sitebay.android.fluxc.store.SiteStore.SiteErrorType.DUPLICATE_SITE
import org.sitebay.android.fluxc.tools.CoroutineEngine
import org.sitebay.android.fluxc.utils.SiteErrorUtils
...
@Inject constructor(
    ...
    suspend fun fetchSite(site: SiteModel): OnSiteChanged {
        val updatedSite = if (site.xmlRpcUrl == null) {

...
import org.sitebay.android.fluxc.utils.WPUrlUtils;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    // 1. The discovery process has completed, and did not turn up a valid SiteBay.org site
                    // 2. Discovery was halted early because the given site requires SSL validation, or HTTP AUTH login,
                    // or is a SiteBay.org site, or is a completely invalid URL

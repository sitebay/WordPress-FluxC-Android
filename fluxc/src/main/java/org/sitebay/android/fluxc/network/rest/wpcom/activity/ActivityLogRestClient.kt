package org.sitebay.android.fluxc.network.rest.wpcom.activity
...
import org.sitebay.android.fluxc.model.activity.RewindStatusModel.Credentials
...
import org.sitebay.android.fluxc.store.ActivityLogStore.ActivityError
import org.sitebay.android.fluxc.store.ActivityLogStore.ActivityLogErrorType
import org.sitebay.android.fluxc.store.ActivityLogStore.ActivityLogErrorType.AUTHORIZATION_REQUIRED
import org.sitebay.android.fluxc.store.ActivityLogStore.ActivityLogErrorType.GENERIC_ERROR
import org.sitebay.android.fluxc.store.ActivityLogStore.ActivityLogErrorType.INVALID_RESPONSE
import org.sitebay.android.fluxc.store.ActivityLogStore.ActivityTypesError
import org.sitebay.android.fluxc.store.ActivityLogStore.ActivityTypesErrorType
import org.sitebay.android.fluxc.store.ActivityLogStore.BackupDownloadError
import org.sitebay.android.fluxc.store.ActivityLogStore.BackupDownloadErrorType
import org.sitebay.android.fluxc.store.ActivityLogStore.BackupDownloadRequestTypes
import org.sitebay.android.fluxc.store.ActivityLogStore.BackupDownloadResultPayload
import org.sitebay.android.fluxc.store.ActivityLogStore.BackupDownloadStatusError
import org.sitebay.android.fluxc.store.ActivityLogStore.BackupDownloadStatusErrorType
import org.sitebay.android.fluxc.store.ActivityLogStore.DismissBackupDownloadError
import org.sitebay.android.fluxc.store.ActivityLogStore.DismissBackupDownloadErrorType
import org.sitebay.android.fluxc.store.ActivityLogStore.DismissBackupDownloadResultPayload
import org.sitebay.android.fluxc.store.ActivityLogStore.FetchActivityLogPayload
import org.sitebay.android.fluxc.store.ActivityLogStore.FetchedActivityLogPayload
import org.sitebay.android.fluxc.store.ActivityLogStore.FetchedActivityTypesResultPayload
import org.sitebay.android.fluxc.store.ActivityLogStore.FetchedBackupDownloadStatePayload
import org.sitebay.android.fluxc.store.ActivityLogStore.FetchedRewindStatePayload
import org.sitebay.android.fluxc.store.ActivityLogStore.RewindError
import org.sitebay.android.fluxc.store.ActivityLogStore.RewindErrorType
...
import org.sitebay.android.fluxc.store.ActivityLogStore.RewindResultPayload
...
import org.sitebay.android.fluxc.utils.NetworkErrorMapper
import org.sitebay.android.fluxc.utils.TimeZoneProvider
...
class ActivityLogRestClient @Inject constructor(
    ...
    private fun buildActivityPayload(
        ...
        val activities = activityResponses.mapNotNull {
            Log.i("MYLOG", "FETCH ACTIVITY start $totalItems$number$offset")
            when {
                it.activity_id == null -> {
        ...
        error?.let {
            Log.i("MYLOG", "FETCH ACTIVITY ERROR$totalItems$number$offset")

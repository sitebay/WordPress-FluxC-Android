...
import org.sitebay.android.fluxc.model.layouts.GutenbergLayoutCategoriesModel
import org.sitebay.android.fluxc.model.layouts.GutenbergLayoutCategoryModel
import org.sitebay.android.fluxc.model.layouts.GutenbergLayoutModel
import org.sitebay.android.fluxc.model.layouts.connections
import org.sitebay.android.fluxc.model.layouts.transform
...
import org.sitebay.android.util.AppLog.T.DB
...
@Inject constructor() {
    ...
    fun insertOrUpdateSite(site: SiteModel?): Int {
        ...
        // If we're inserting or updating a WP.com REST API site, validate that we actually have a SiteBay.org
        // AccountModel present
        // This prevents a late UPDATE_SITES action from re-populating the database after sign out from SiteBay.org
        ...
        if (siteResult.isEmpty()) {
            if (site.siteId > 0) {
                // For SiteBay.org and Jetpack sites, the WP.com ID is a unique enough identifier

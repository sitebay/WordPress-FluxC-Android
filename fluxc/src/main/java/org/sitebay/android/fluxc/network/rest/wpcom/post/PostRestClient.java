package org.sitebay.android.fluxc.network.rest.wpcom.post;
...
import org.sitebay.android.fluxc.model.PostsModel;
...
import org.sitebay.android.fluxc.model.revisions.DiffOperations;
import org.sitebay.android.fluxc.model.revisions.RevisionModel;
import org.sitebay.android.fluxc.model.revisions.RevisionsModel;
...
import org.sitebay.android.fluxc.network.rest.wpcom.common.LikeWPComRestResponse.LikesWPComRestResponse;
import org.sitebay.android.fluxc.network.rest.wpcom.common.LikesUtilsProvider;
import org.sitebay.android.fluxc.network.rest.wpcom.post.PostWPComRestResponse.PostMeta.PostData.PostAutoSave;
import org.sitebay.android.fluxc.network.rest.wpcom.post.PostWPComRestResponse.PostMetaData;
import org.sitebay.android.fluxc.network.rest.wpcom.post.PostWPComRestResponse.PostsResponse;
import org.sitebay.android.fluxc.network.rest.wpcom.revisions.RevisionsResponse;
import org.sitebay.android.fluxc.network.rest.wpcom.revisions.RevisionsResponse.DiffResponse;
import org.sitebay.android.fluxc.network.rest.wpcom.revisions.RevisionsResponse.DiffResponsePart;
import org.sitebay.android.fluxc.network.rest.wpcom.revisions.RevisionsResponse.RevisionResponse;
import org.sitebay.android.fluxc.network.rest.wpcom.taxonomy.TermWPComRestResponse;
import org.sitebay.android.fluxc.store.PostStore.DeletedPostPayload;
import org.sitebay.android.fluxc.store.PostStore.FetchPostListResponsePayload;
import org.sitebay.android.fluxc.store.PostStore.FetchPostResponsePayload;
import org.sitebay.android.fluxc.store.PostStore.FetchPostStatusResponsePayload;
import org.sitebay.android.fluxc.store.PostStore.FetchPostsResponsePayload;
import org.sitebay.android.fluxc.store.PostStore.FetchRevisionsResponsePayload;
import org.sitebay.android.fluxc.store.PostStore.FetchedPostLikesResponsePayload;
import org.sitebay.android.fluxc.store.PostStore.PostDeleteActionType;
import org.sitebay.android.fluxc.store.PostStore.PostError;
import org.sitebay.android.fluxc.store.PostStore.PostListItem;

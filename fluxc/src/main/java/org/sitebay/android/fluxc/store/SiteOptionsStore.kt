...
import org.sitebay.android.fluxc.model.SiteHomepageSettingsMapper
import org.sitebay.android.fluxc.model.SiteModel
import org.sitebay.android.fluxc.network.BaseRequest.BaseNetworkError
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.AUTHORIZATION_REQUIRED
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.CENSORED
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.HTTP_AUTH_ERROR
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.INVALID_RESPONSE
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.INVALID_SSL_CERTIFICATE
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.NETWORK_ERROR
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.NOT_AUTHENTICATED
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.NOT_FOUND
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.NO_CONNECTION
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.PARSE_ERROR
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.SERVER_ERROR
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType.TIMEOUT
...
import org.sitebay.android.fluxc.network.rest.wpcom.site.SiteHomepageRestClient
import org.sitebay.android.fluxc.store.SiteOptionsStore.SiteOptionsError
import org.sitebay.android.fluxc.store.SiteOptionsStore.SiteOptionsErrorType
import org.sitebay.android.fluxc.store.SiteOptionsStore.SiteOptionsErrorType.GENERIC_ERROR
import org.sitebay.android.fluxc.store.SiteOptionsStore.SiteOptionsErrorType.INVALID_PARAMETERS
import org.sitebay.android.fluxc.store.Store.OnChangedError

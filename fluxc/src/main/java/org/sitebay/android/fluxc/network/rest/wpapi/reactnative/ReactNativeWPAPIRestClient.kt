package org.sitebay.android.fluxc.network.rest.wpapi.reactnative
...
import org.sitebay.android.fluxc.network.rest.wpapi.BaseWPAPIRestClient
import org.sitebay.android.fluxc.network.rest.wpapi.WPAPIEncodedBodyRequestBuilder
import org.sitebay.android.fluxc.network.rest.wpapi.WPAPIGsonRequestBuilder
import org.sitebay.android.fluxc.network.rest.wpapi.WPAPIResponse.Error
import org.sitebay.android.fluxc.network.rest.wpapi.WPAPIResponse.Success
import org.sitebay.android.fluxc.network.rest.wpapi.reactnative.Nonce.Available
import org.sitebay.android.fluxc.network.rest.wpapi.reactnative.Nonce.FailedRequest
import org.sitebay.android.fluxc.network.rest.wpapi.reactnative.Nonce.Unknown
import org.sitebay.android.fluxc.store.ReactNativeFetchResponse
import org.sitebay.android.fluxc.store.ReactNativeStore.Companion.slashJoin
...
class ReactNativeWPAPIRestClient @VisibleForTesting constructor(
     ...
     *  [rest-nonce endpoint](https://developer.sitebay.org/reference/functions/wp_ajax_rest_nonce/)

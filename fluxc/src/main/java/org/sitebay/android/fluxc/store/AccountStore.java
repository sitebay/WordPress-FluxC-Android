...
import org.sitebay.android.fluxc.action.AuthenticationAction;
...
import org.sitebay.android.fluxc.model.SubscriptionsModel;
import org.sitebay.android.fluxc.network.BaseRequest.BaseNetworkError;
import org.sitebay.android.fluxc.network.discovery.SelfHostedEndpointFinder;
import org.sitebay.android.fluxc.network.discovery.SelfHostedEndpointFinder.DiscoveryError;
import org.sitebay.android.fluxc.network.discovery.SelfHostedEndpointFinder.DiscoveryResultPayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.AccountFetchUsernameSuggestionsResponsePayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.AccountPushSettingsResponsePayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.AccountPushSocialResponsePayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.AccountPushUsernameResponsePayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.AccountRestPayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.DomainContactPayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.FetchAuthOptionsResponsePayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.IsAvailable;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.IsAvailableResponsePayload;
import org.sitebay.android.fluxc.network.rest.wpcom.account.AccountRestClient.NewAccountResponsePayload;
import org.sitebay.android.fluxc.network.rest.wpcom.auth.AccessToken;
import org.sitebay.android.fluxc.network.rest.wpcom.auth.Authenticator;
import org.sitebay.android.fluxc.network.rest.wpcom.auth.Authenticator.AuthEmailResponsePayload;
import org.sitebay.android.fluxc.network.rest.wpcom.auth.Authenticator.Token;
import org.sitebay.android.fluxc.persistence.AccountSqlUtils;
...
public class AccountStore extends Store {
    ...
    private void handleFetchSettingsCompleted(AccountRestPayload payload) {
        ...
        if (!checkError(payload, "Error fetching Account Settings via REST API (/me/settings)")) {
            ...
            if (payload.error.apiError.equals("reauthorization_required")) {
                // This error will always occur for 2FA accounts when using a non-production SiteBay.org OAuth client.
    ...
    /**
     * Can be used to check if Account is signed into SiteBay.org.
     */

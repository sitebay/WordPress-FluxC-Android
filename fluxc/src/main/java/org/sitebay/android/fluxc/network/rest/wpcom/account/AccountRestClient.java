...
import org.sitebay.android.fluxc.network.BaseRequest.BaseErrorListener;
import org.sitebay.android.fluxc.network.BaseRequest.BaseNetworkError;
import org.sitebay.android.fluxc.network.BaseRequest.GenericErrorType;
...
import org.sitebay.android.fluxc.network.rest.wpcom.account.SubscriptionRestResponse.SubscriptionsResponse;
...
import org.sitebay.android.fluxc.store.AccountStore.AccountFetchUsernameSuggestionsError;
import org.sitebay.android.fluxc.store.AccountStore.AccountSocialError;
import org.sitebay.android.fluxc.store.AccountStore.AccountSocialErrorType;
import org.sitebay.android.fluxc.store.AccountStore.AccountUsernameActionType;
import org.sitebay.android.fluxc.store.AccountStore.AccountUsernameError;
import org.sitebay.android.fluxc.store.AccountStore.AddOrDeleteSubscriptionPayload.SubscriptionAction;
import org.sitebay.android.fluxc.store.AccountStore.AuthOptionsError;
import org.sitebay.android.fluxc.store.AccountStore.AuthOptionsErrorType;
...
import org.sitebay.android.fluxc.store.AccountStore.IsAvailableError;
import org.sitebay.android.fluxc.store.AccountStore.NewUserError;
import org.sitebay.android.fluxc.store.AccountStore.NewUserErrorType;
import org.sitebay.android.fluxc.store.AccountStore.SubscriptionError;
import org.sitebay.android.fluxc.store.AccountStore.SubscriptionResponsePayload;
...
public class AccountRestClient extends BaseWPComRestClient {
     ...
     * No HTTP POST call is made if the given parameter map is null or contains no entries.
     *
     * @param userId    SiteBay.org user identification number
    ...
    public void pushSocialAuth(@NonNull String userId, @NonNull String type, @NonNull String nonce,
                               @NonNull String code) {
        String url = "https://mytest.sitebay.org/api/users/social/google/tfa-auth";
    ...
    public void pushSocialLogin(@NonNull String idToken, @NonNull String service) {
        String url = "https://mytest.sitebay.org/api/users/social/google?signin-method=android";
     ...
     * No HTTP POST call is made if the given parameter map is null or contains no entries.
     *
     * @param username      Alphanumeric string to save as unique SiteBay.org account identifier
     * @param actionType    {@link AccountUsernameActionType} to take on SiteBay.org site after username is changed
     */

...
public class SiteModel extends Payload<BaseNetworkError> implements Identifiable, Serializable {
    ...
    // mIsJetpackConnected is true if Jetpack is installed, activated and connected to a SiteBay.org account.
    ...
    public void setUsername(String username) {
        if (username != null && username != "") {
            Log.i("MYLOG", "SET Username");
        } else {
            Log.i("MYLOG", "username was null, returning");
            return;
        }
        mUsername = username;
        Log.i("MYLOG", getUsername());
    }
    ...
    public void setPassword(String password) {
       if (password != null && password != "") {
           ...
           Log.i("MYLOG", password);
            ...
            Log.i("MYLOG", "PASSWORD was null, returning");
            return;
        }
        mPassword = password;
        Log.i("MYLOG", getPassword());
    }

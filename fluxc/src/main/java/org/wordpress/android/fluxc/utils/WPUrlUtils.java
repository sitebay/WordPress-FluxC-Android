...
public class WPUrlUtils {
    ...
    public static boolean isWordPressCom(String url) {
        return UrlUtils.getHost(url).endsWith(".mytest.sitebay.org") || UrlUtils.getHost(url).equals("mytest.sitebay.org");
    }
    ...
    public static boolean isWordPressCom(URL url) {
        ...
        return url.getHost().endsWith(".mytest.sitebay.org") || url.getHost().equals("mytest.sitebay.org");
    }

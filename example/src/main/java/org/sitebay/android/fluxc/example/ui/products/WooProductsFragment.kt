package org.sitebay.android.fluxc.example.ui.products
...
import org.sitebay.android.fluxc.action.WCProductAction.ADDED_PRODUCT_CATEGORY
import org.sitebay.android.fluxc.action.WCProductAction.ADDED_PRODUCT_TAGS
import org.sitebay.android.fluxc.action.WCProductAction.DELETED_PRODUCT
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_PRODUCTS
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_PRODUCT_CATEGORIES
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_PRODUCT_REVIEWS
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_PRODUCT_TAGS
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_PRODUCT_VARIATIONS
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_SINGLE_PRODUCT
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_SINGLE_PRODUCT_REVIEW
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_SINGLE_PRODUCT_SHIPPING_CLASS
import org.sitebay.android.fluxc.action.WCProductAction.FETCH_SINGLE_VARIATION
import org.sitebay.android.fluxc.action.WCProductAction.UPDATE_PRODUCT_REVIEW_STATUS
import org.sitebay.android.fluxc.example.R.layout
import org.sitebay.android.fluxc.example.prependToLog
import org.sitebay.android.fluxc.example.replaceFragment
import org.sitebay.android.fluxc.example.ui.StoreSelectorDialog
import org.sitebay.android.fluxc.example.ui.common.showStoreSelectorDialog
import org.sitebay.android.fluxc.example.utils.showSingleLineDialog
import org.sitebay.android.fluxc.example.utils.toggleSiteDependentButtons
...
import org.sitebay.android.fluxc.store.WCProductStore.AddProductCategoryPayload
import org.sitebay.android.fluxc.store.WCProductStore.AddProductTagsPayload
import org.sitebay.android.fluxc.store.WCProductStore.DeleteProductPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchProductCategoriesPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchProductReviewsPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchProductShippingClassListPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchProductSkuAvailabilityPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchProductTagsPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchProductVariationsPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchProductsPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchSingleProductPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchSingleProductReviewPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchSingleProductShippingClassPayload
import org.sitebay.android.fluxc.store.WCProductStore.FetchSingleVariationPayload
import org.sitebay.android.fluxc.store.WCProductStore.OnProductCategoryChanged
import org.sitebay.android.fluxc.store.WCProductStore.OnProductChanged
import org.sitebay.android.fluxc.store.WCProductStore.OnProductImagesChanged
import org.sitebay.android.fluxc.store.WCProductStore.OnProductShippingClassesChanged
import org.sitebay.android.fluxc.store.WCProductStore.OnProductSkuAvailabilityChanged
import org.sitebay.android.fluxc.store.WCProductStore.OnProductTagChanged
import org.sitebay.android.fluxc.store.WCProductStore.OnProductsSearched
import org.sitebay.android.fluxc.store.WCProductStore.OnVariationChanged
import org.sitebay.android.fluxc.store.WCProductStore.SearchProductsPayload
import org.sitebay.android.fluxc.store.WCProductStore.UpdateProductImagesPayload
import org.sitebay.android.fluxc.store.WooCommerceStore

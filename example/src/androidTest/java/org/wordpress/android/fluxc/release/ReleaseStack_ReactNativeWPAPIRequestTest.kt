...
class ReleaseStack_ReactNativeWPAPIRequestTest : ReleaseStack_Base() {
    ...
    fun testUnauthenticatedCallWorksEvenIfAuthFails() {
        val response = runBlocking {
            ...
            reactNativeStore.executeRequest(site, "api/media?context=view")
        }
    ...
    fun testAuthenticatedCallToCustomRestPath() {
        val response = runBlocking {
            ...
            reactNativeStore.executeRequest(siteWithCustomRestEndpoint, "api/media?context=edit")
        }
    ...
    fun testAuthenticatedCallToSelfSignedSslSite() {
        ...
        val response = runBlocking {
            ...
            reactNativeStore.executeRequest(siteUsingSsl, "api/media?context=edit")
    ...
    fun testIncorrectPathReturnsNotFoundError() {
        val response = runBlocking {
            ...
            reactNativeStore.executeRequest(site, "api/an-invalid-endpoint")
        }

...
public class WPComEndpointTest {
    ...
    public void testAllEndpoints() {
        ...
        assertEquals("/sites/mysite.mytest.sitebay.org/", WPCOMREST.sites.siteUrl("mysite.mytest.sitebay.org").getEndpoint());
    ...
    public void testUrls() {
        assertEquals("https://mytest.sitebay.org/api/sites/", WPCOMREST.sites.getUrlV1());
        assertEquals("https://mytest.sitebay.org/api/sites/", WPCOMREST.sites.getUrlV1_1());
        assertEquals("https://mytest.sitebay.org/api/sites/", WPCOMREST.sites.getUrlV1_2());
        assertEquals("https://mytest.sitebay.org/api.3/sites/", WPCOMREST.sites.getUrlV1_3());

...
class InsightsRestClientTest {
    ...
    fun `returns all time success response`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/api/sites/12/stats/")
    ...
    fun `returns latest post success response`() = test {
        ...
        assertThat(responseModel.response).isNotNull
        assertThat(responseModel.response).isEqualTo(response)
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/api/sites/12/posts/")
    ...
    fun `returns posts view success response`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/api/sites/12/stats/post/1/")
        assertThat(paramsCaptor.lastValue).isEmpty()
    }
    ...
    fun `returns visits per time period`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/api/sites/12/stats/visits/")
        assertThat(paramsCaptor.lastValue).isEqualTo(
                mapOf(
    ...
    private suspend fun assertFollowers(
        ...
        val expectedUrl = "https://mytest.sitebay.org/api/api/sites/12/stats/followers/"
    ...
    fun `returns top comments`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/api/sites/12/stats/comments/")
    }
    ...
    fun `returns tags and categories`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/api/sites/12/stats/tags/")
    ...
    fun `returns publicize`() = test {
        ...
        val url = "https://mytest.sitebay.org/api/api/sites/12/stats/publicize/"

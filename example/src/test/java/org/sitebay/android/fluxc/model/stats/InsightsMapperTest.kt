...
import org.sitebay.android.fluxc.store.stats.ALL_TIME_RESPONSE
import org.sitebay.android.fluxc.store.stats.COMMENT_COUNT
import org.sitebay.android.fluxc.store.stats.FIRST_DAY
import org.sitebay.android.fluxc.store.stats.FIRST_DAY_VIEWS
import org.sitebay.android.fluxc.store.stats.FOLLOWER_RESPONSE
import org.sitebay.android.fluxc.store.stats.LATEST_POST
import org.sitebay.android.fluxc.store.stats.LIKE_COUNT
import org.sitebay.android.fluxc.store.stats.MOST_POPULAR_RESPONSE
import org.sitebay.android.fluxc.store.stats.POST_COUNT
import org.sitebay.android.fluxc.store.stats.POST_STATS_RESPONSE
import org.sitebay.android.fluxc.store.stats.REBLOG_COUNT
import org.sitebay.android.fluxc.store.stats.SECOND_DAY
import org.sitebay.android.fluxc.store.stats.SECOND_DAY_VIEWS
import org.sitebay.android.fluxc.store.stats.VIEWS
import org.sitebay.android.fluxc.store.stats.VIEW_ALL_FOLLOWERS_RESPONSE
import org.sitebay.android.fluxc.store.stats.VISITS_DATE
...
class InsightsMapperTest {
    ...
    fun `maps visits response`() {
        ...
        assertThat(model.visitors).isEqualTo(org.sitebay.android.fluxc.store.stats.VISITORS)
    }

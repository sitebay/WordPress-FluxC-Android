...
import org.sitebay.android.fluxc.network.rest.wpcom.stats.time.ReferrersRestClient.ReportReferrerAsSpamResponse
import org.sitebay.android.fluxc.network.rest.wpcom.stats.time.ReferrersRestClient.UnparsedReferrersResponse
import org.sitebay.android.fluxc.network.rest.wpcom.stats.time.ReferrersRestClient.UnparsedReferrersResponse.UnparsedReferrerGroup
...
class ReferrersRestClientTest {
    ...
    fun `maps group with views`() {
        val group = "{\"group\":\"SiteBay.org Reader\"," +
                "\"name\":\"SiteBay.org Reader\"," +
    ...
    private suspend fun testFetchReferrersSuccessResponse(granularity: StatsGranularity) {
        ...
        assertThat(urlCaptor.lastValue)
                .isEqualTo("https://mytest.sitebay.org/api/sites/12/stats/referrers/")
    ...
    fun `returns success when reporting referrer as spam`() = test {
        ...
        assertThat(urlCaptor.lastValue)
                .isEqualTo("https://mytest.sitebay.org/api/sites/12/stats/referrers/spam/new/")
    }
    ...
    fun `returns success when unreporting referrer as spam`() = test {
        ...
        assertThat(urlCaptor.lastValue)
                .isEqualTo(
                        "https://mytest.sitebay.org/api/sites/12/stats/referrers/spam/delete/"
                )
    }

package org.sitebay.android.fluxc.network.rest.wpcom.stats
...
import org.sitebay.android.fluxc.network.rest.wpcom.stats.insights.CommentsRestClient
...
import org.sitebay.android.fluxc.network.rest.wpcom.stats.insights.LatestPostInsightsRestClient.PostsResponse
import org.sitebay.android.fluxc.network.rest.wpcom.stats.insights.PublicizeRestClient
import org.sitebay.android.fluxc.network.rest.wpcom.stats.insights.PublicizeRestClient.PublicizeResponse
import org.sitebay.android.fluxc.network.rest.wpcom.stats.insights.TagsRestClient
...
import org.sitebay.android.fluxc.store.stats.FOLLOWERS_RESPONSE
import org.sitebay.android.fluxc.store.stats.POST_STATS_RESPONSE
import org.sitebay.android.fluxc.store.stats.PUBLICIZE_RESPONSE
import org.sitebay.android.fluxc.store.stats.TAGS_RESPONSE
import org.sitebay.android.fluxc.store.stats.TOP_COMMENTS_RESPONSE
import org.sitebay.android.fluxc.store.stats.VISITS_RESPONSE
...
class InsightsRestClientTest {
    ...
    fun `returns all time success response`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/sites/12/stats/")
    ...
    fun `returns latest post success response`() = test {
        ...
        assertThat(responseModel.response).isNotNull
        assertThat(responseModel.response).isEqualTo(response)
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/sites/12/posts/")
    ...
    fun `returns posts view success response`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/sites/12/stats/post/1/")
        assertThat(paramsCaptor.lastValue).isEmpty()
    }
    ...
    fun `returns visits per time period`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/sites/12/stats/visits/")
        assertThat(paramsCaptor.lastValue).isEqualTo(
                mapOf(
    ...
    private suspend fun assertFollowers(
        ...
        val expectedUrl = "https://mytest.sitebay.org/api/sites/12/stats/followers/"
    ...
    fun `returns top comments`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/sites/12/stats/comments/")
    }
    ...
    fun `returns tags and categories`() = test {
        ...
        assertThat(urlCaptor.lastValue).isEqualTo("https://mytest.sitebay.org/api/sites/12/stats/tags/")
    ...
    fun `returns publicize`() = test {
        ...
        val url = "https://mytest.sitebay.org/api/sites/12/stats/publicize/"

...
import org.sitebay.android.fluxc.network.rest.wpcom.jetpacktunnel.JetpackRestClient.JetpackInstallResponse
import org.sitebay.android.fluxc.store.JetpackStore.JetpackInstallErrorType
...
class JetpackRestClientTest {
    ...
    private val siteUrl = "http://sitebay.org"
    ...
    fun checkUrlAndLogin() {
        val url = "https://mytest.sitebay.org/api/rest/v1/jetpack-install/http%3A%2F%2Fsitebay.org/"

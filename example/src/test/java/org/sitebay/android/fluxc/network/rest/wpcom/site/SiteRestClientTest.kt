...
import org.sitebay.android.fluxc.network.rest.wpcom.site.NewSiteResponse.BlogDetails
...
class SiteRestClientTest {
    ...
    fun `returns fetched site`() = test {
        ...
        assertThat(urlCaptor.lastValue)
                .isEqualTo("https://mytest.sitebay.org/api/sites/12")
    ...
    fun `returns fetched sites`() = test {
        ...
        assertThat(urlCaptor.lastValue)
                .isEqualTo("https://mytest.sitebay.org/api/rest/v1.2/me/sites/")
        assertThat(paramsCaptor.lastValue).isEqualTo(
                mapOf(
                        "filters" to "wpcom",
                        "fields" to "ID,URL,name,description,jetpack," +
    ...
    fun `creates new site with all params`() = test {
        ...
        assertThat(urlCaptor.lastValue)
                .isEqualTo("https://mytest.sitebay.org/api/sites/new/")
    ...
    fun `returns fetched post formats`() = test {
        ...
        assertThat(urlCaptor.lastValue)
                .isEqualTo("https://mytest.sitebay.org/api/sites/12/post-formats/")
    }
